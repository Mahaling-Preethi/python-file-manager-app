...
def renameAFile():
    ...
    rename_win.geometry("300x100+580+280")
...
if __name__ == "__main__":
    ...
    win_root.geometry("400x600+520+50")
    win_root.iconbitmap(r'C:\Users\pc\OneDrive\Desktop\My-Projects\File-Manager-app\folder.ico')
    ...
    header_label = Label(
        header_frame,text="File Explorer",font=("Calibri", "16"), bg='#D8E9E6',fg="black"
    )
